...
public class TelaSaida extends javax.swing.JFrame {
    ...
    private List<Cliente> lCli = new ArrayList<Cliente>();
    ...
    private void montaComboBox() {
        ...
        lCli = Cliente.getLista();
        // preenchendo combobox produtos
        cbProduto.removeAllItems();
        for (Produto i: lProd) {
            cbProduto.addItem(i.getDescricao());
        }
        // preenchendo combobox clientes
        cbCliente.removeAllItems();
        for (Cliente i: lCli) {
            cbCliente.addItem(i.getNome());
        }
    }
    ...
    private void btGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btGravarActionPerformed
        ...
        Cliente cliente = lCli.get(cbCliente.getSelectedIndex());
        int qtde = Integer.parseInt(tfQtde.getText());
        double valor = Double.parseDouble(tfValor.getText());
        new Saida(data,produto,cliente,qtde,valor).gravar();
